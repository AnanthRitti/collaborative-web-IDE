  ...
  return (
    ...
    <div className="grid md:grid-cols-2 items-center gap-8 h-full">
      <form className="max-w-lg max-md:mx-auto w-full p-6">
        ...
        <p className="text-sm mt-8 text-center text-gray-800">Don't have an account? <a href="#" className="text-blue-600 font-semibold tracking-wide hover:underline ml-1">Register here</a></p>
      </form>
